...
//
// The Redigo FAQ (https://gitlab.kingbay-tech.com/engine-lottery/magneto/pkg/redigo/wiki/FAQ) contains more
...
//      // handle error
//  }
package redis // import "gitlab.kingbay-tech.com/engine-lottery/magneto/pkg/redigo/redis"
